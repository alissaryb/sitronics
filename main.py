...
def get_courses():
    return [
        {"id": 0, "name_course" : "Введение в SQL", "id_teacher" : 0, "address" : "", "coords": "", "type_online" : 1, "organization" : "МТС", "date_day" : "Четверг", "time_start" : "10:00", "time_end" : "12:00", "price" : 300, "rank" : 9.5, "verified" : 1},
         ...
         {"id": 5, "name_course": "Физический эксперементариум ", "id_teacher" : 2, "address" : "3 Lenin Square, Republic of Mari El, Russia",  "coords": [56.630733, 47.892071], "type_online": 0,"organization" : "Volga Region University", "date_day": "Пятница", "time_start" : "15:00", "time_end" : "17:00", "price": 10000, "rank" : 1.5, "verified" : 0},]
def get_teachers():
